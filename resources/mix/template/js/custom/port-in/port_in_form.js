...
var KTRefillGeneral = function () {
            ...
            form,
            {
                fields: {
                    ...
                    'ported_number': {
                        validators: {
                            notEmpty: {
                                message: 'Number to be ported is required!'
                            }
                        }
                    },
                    'current_carrier': {
                        validators: {
                            notEmpty: {
                                message: 'Please select current carrier!'
                            }
                        }
                    },
                    'current_carrier_account_number': {
                        validators: {
                            notEmpty: {
                                message: 'Current carrier account number is required!'
                            }
                        }
                    },
                    'current_carrier_account_pin': {
                        validators: {
                            notEmpty: {
                                message: 'Current carrier account pin or password is required!'
                            }
                        }
                    },
                    'sim_card_number': {
                ...
                if (status === 'Valid') {
                    ...
                    axios.post(form.getAttribute('action'), formData)
                        .then(function (response) {
                            ...
                            Swal.fire({
                                text: "Port-In request has been submitted successfully!",
                                icon: "success",
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    form.querySelector('[name="ported_number"]').value = "";
                                    form.querySelector('[name="current_carrier"]').value = "";
                                    form.querySelector('[name="current_carrier_account_number"]').value = "";
                                    form.querySelector('[name="current_carrier_account_pin"]').value = "";
    ...
    return {
        // Initialization
        init: function () {
            form = document.querySelector('#portInForm');
