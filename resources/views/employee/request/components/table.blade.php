    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('body').on('click', '#kt_drawer_example_dismiss_button', function (event) {
                ...
                $.get('/employee/request/' + id, function (data) {
                    ...
                    $('#drawerRequestClientName').text(data.client.user.first_name + ' ' + data.client.user.last_name);
                    $('#drawerRequestClientEmail').text(data.client.user.email);
