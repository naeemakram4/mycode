...
<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
    ...
    <div class="card" id="kt_chat_messenger">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                ...
                                @if($comment->file)
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <a href="{{ route('employee.task.comment.file.download', $comment->id) }}" class="me-2" data-bs-toggle="tooltip" title="" data-bs-original-title="Download">
        ...
        <div class="card-footer pt-4" id="kt_chat_messenger_footer">
            <form action="{{ route('employee.task.comment.submit', $task->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!--begin::Input-->
