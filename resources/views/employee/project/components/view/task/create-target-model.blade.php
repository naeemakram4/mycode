    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form method="POST" action="{{ route('employee.task.store') }}" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    <!--begin::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Task Subject</span>
                    ...
                    <div class="d-flex flex-column mb-8">
                        ...
                        <textarea class="form-control form-control-solid" rows="3" name="description" placeholder="Type Task Description"></textarea>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
