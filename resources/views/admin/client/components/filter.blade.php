...
{{--                    </div>--}}
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="search_company" name="search_company" class="form-control form-control-sm" placeholder="Search Company"/>
                    </div>

                    <div class="col-md-2">
                        <a href="{{ route('admin.client.index') }}" data-repeater-delete class="btn btn-sm btn-light-primary mt-3 mt-md-9">
