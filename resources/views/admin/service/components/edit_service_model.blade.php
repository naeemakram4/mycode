<div class="modal fade" id="editServiceModel" tabindex="-1" role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-450px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3">
                <!--begin::Form-->
                <form method="POST" class="form" id="serviceEditForm">
                    @csrf
                    @method('PUT')
                    <!--begin::Input group-->
                    ...
                    <div class="text-center pt-7">
                        <button type="submit" class="btn btn-primary" data-kt-stepper-action="next">Update Service
