<div class="modal fade" id="editDesignModal" tabindex="-1" role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-450px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body  mx-3 mx-xl-5 my-3">
                <!--begin::Form-->
                <form method="POST" class="form" id="editDesignForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <input type="file" name="edit_image" class="form-control form-control-sm form-control-solid" value="{{old('sku')}}">
                    </div>
                    <!--end::Input group-->
