...
<div class="col-md-4 col-lg-12 col-xl-4">
    ...
    <div class="mb-9">
        <div class="d-flex flex-stack">
            <div class="fw-bolder fs-4">{{ str_replace('_',' ', \App\Models\Task::COMPLETED_STATUS) }}
                <span class="fs-6 text-gray-400 ms-2">{{ $project->tasks->filter(function($task) { return $task->status == \App\Models\Task::COMPLETED_STATUS; })->count() }}</span></div>
            <!--begin::Menu-->
            <div>
...
{{--                </div>--}}
    ...
    <!--end::Col header-->
    @foreach($project->tasks->filter(function ($item) { return $item->status == \App\Models\Task::COMPLETED_STATUS;}) as $task)
        <!--begin::Card-->
