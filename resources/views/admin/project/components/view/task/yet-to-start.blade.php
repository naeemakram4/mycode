    ...
    <div class="mb-9">
        <div class="d-flex flex-stack">
            <div class="fw-bolder fs-4">{{ str_replace('_',' ', \App\Models\Task::YET_TO_STATUS) }}
                <span class="fs-6 text-gray-400 ms-2">{{ $project->tasks->filter(function($task) { return $task->status == \App\Models\Task::YET_TO_STATUS; })->count() }}</span>
            </div>
            <!--begin::Menu-->
            <div>
...
{{--                            <!--end::Menu item-->--}}
                ...
                <!--begin::Title-->
                <div class="mb-2">
                    <a href="javascript:void(0);" id="kt_drawer_example_dismiss_button" class="fs-4 fw-bolder mb-1 text-gray-900 text-hover-primary">{{ $task->subject }}</a>
                </div>
                <!--end::Title-->
                <!--begin::Content-->
