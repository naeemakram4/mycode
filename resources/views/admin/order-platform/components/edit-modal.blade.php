<div class="modal fade" id="editOriginModal" tabindex="-1" role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-450px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body  mx-3 mx-xl-5 my-3">
                <!--begin::Form-->
                <form method="POST" class="form" id="editOriginForm">
                @csrf
                @method('PUT')
                    <!--begin::Input group-->
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" id="updateBtn" class="btn btn-sm btn-primary">Update</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
