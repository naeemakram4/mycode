<table id="kt_datatable_example_1" class="table table-row-bordered gy-5">
    ...
    <tbody>
        <tr>
            <td>
                <a href="{{ route('admin.invoice.show', 31202) }}">31202</a>
            </td>
            <td>John Doe</td>
            <td>DD App Start</td>
            <td>$102.00</td>
        ...
        <tr>
            <td>
                <a href="{{ route('admin.invoice.show', 34782) }}">34782</a>
            </td>
            <td>John Doe</td>
            <td>Front-end Basics</td>
            <td>$102.00</td>
            <td>02-08-2024 <br> 03-18-2024</td>
        ...
        <tr>
            <td>
                <a href="{{ route('admin.invoice.show', 35782) }}">34782</a>
            </td>
            <td>Danial White</td>
            <td>Front-end Basics</td>
            <td>$1023.00</td>
            <td>02-08-2024 <br> 02-18-2024</td>
            <td><span class="badge badge-light-danger">Overdue</span></td>
            <td>
                <div class="d-flex justify-content-end flex-shrink-0">
                    <a href="javascript:void(0);" id="" data-id="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                        <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
