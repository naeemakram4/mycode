                        ...
                        <div class="m-0">
                            ...
                            <div class="row g-5 mb-11">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <!--end::Label-->
                                    <!--end::Col-->
                                    <div class="fw-bolder fs-6 text-gray-800">12 Nov 2023</div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Col-->
                                <!--end::Col-->
                                <div class="col-sm-6">
                                    ...
                                    <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                                        <span class="pe-2">02 Dec 2023</span>
                                        <span class="fs-7 text-danger d-flex align-items-center">
																	<span class="bullet bullet-dot bg-danger me-2"></span>Due in 9 days</span>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Col-->
