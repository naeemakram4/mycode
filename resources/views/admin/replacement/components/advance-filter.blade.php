            ...
            <div class="form-group">
                <div class="form-group row mb-5">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id='orderType' class="form-select form-select-sm form-select-solid"
                                data-control="select2" data-hide-search="true">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id='origin' class="form-select form-select-sm form-select-solid"
                                data-control="select2" data-hide-search="true">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id='shipmentOption' class="form-select form-select-sm form-select-solid"
                                data-control="select2" data-hide-search="true">
                            <option value="">All Shipment Options</option>
                            @foreach($shipmentOptions as $shipmentOption)
                                <option value="{{ $shipmentOption }}">{{ $shipmentOption }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row mb-5">
                    <div class="col-md-3">
                        ...
                        <input id="kt_daterangepicker_1" name="daterange"
                               class="form-control form-control-sm form-control-solid" placeholder="Pick date rage"/>
                    </div>

                    <div class="col-md-3">
                        <a href="{{ route('replacements') }}" data-repeater-delete
                           class="btn btn-sm btn-light-primary mt-3 mt-md-9">
