        ...
        <div class="card-body pt-0">
            <div class="d-flex flex-column gap-10">
                ...
                <div class="fv-row fv-plugins-icon-container">
                    <!--begin::Label-->
                    <label class="required form-label">Add product to this replacement</label>
                    <!--end::Label-->
                    <!--begin::Select2-->
                    <select name="product_id" class="form-select select2-hidden-accessible" data-control="select2"
                ...
                <div class="row">
                    <div class="col">
                        <!--begin::Label-->
                        <label class="form-label">Replacement Part Name</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control" name="part_name" placeholder="" value="{{ old('label_link') }}">
                        <!--end::Input-->
                    </div>

                    <div class="col">
                        <!--begin::Label-->
                        <label class="form-label">Replacement Part Image</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="file" class="form-control" name="part_image" accept=".png, .jpg, .jpeg">
                        <!--end::Input-->
                    </div>
                </div>
                <!--end::Input group-->
