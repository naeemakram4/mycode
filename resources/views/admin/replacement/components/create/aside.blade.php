    ...
    <div class="card card-flush py-4" data-select2-id="select2-data-130-zd8w">
        ...
        <div class="card-body pt-0">
            <div class="d-flex flex-column gap-10">
                ...
                <div class="fv-row">
                    <!--begin::Label-->
                    <label class="form-label mb-5">System ID: <span
                            class="fw-bolder fs-3 ps-5">#14530</span></label>
                    <!--end::Label-->

                    <!--begin::Label-->
                    <label class="required form-label">Replacement ID</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" class="form-control" name="replacement_id" placeholder="Enter order replacement id" value="{{ old('replacement_id') }}" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                ...
                <div class="fv-row fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Select2-->
                    <select name="order_id" class="form-select select2-hidden-accessible" data-control="select2"
                            data-placeholder="Select an option" tabindex="-1"
                            aria-hidden="true">
                        <option></option>
                        @foreach($orders as $order)
                            <option value="{{ $order }}" {{ old('order_id') == $order ? 'selected' : '' }}>
                                {{$order}}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="fv-row fv-plugins-icon-container">
                    <!--begin::Label-->
                    <label class="required form-label">Order Replacement Type</label>
                    <!--end::Label-->
                    <!--begin::Select2-->
                    <select name="order_type" class="form-select select2-hidden-accessible" data-control="select2"
                        ...
                        @foreach($orderTypes as $orderType)
                            <option value="{{ $orderType->id }}" {{ old('order_type') == $orderType->id ? 'selected' : '' }}>
                                {{$orderType->name}}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="fv-row fv-plugins-icon-container">
                    ...
                    <select name="shipment_option" class="form-select select2-hidden-accessible" data-control="select2"
                        ...
                        @foreach($shippingOptions as $shippingOption)
                            <option value="{{ $shippingOption }}" {{ old('shipment_option') == $shippingOption ? 'selected' : '' }}>
                ...
                <div class="fv-row fv-plugins-icon-container">
                    <!--begin::Label-->
                    <label for="orderData" class="required form-label">Order Replacement Date</label>
                    <!--end::Label-->
                    <!--begin::Editor-->
                    <input class="form-control" name="order_date" placeholder="Select a date" id="orderDate"/>
                    <!--end::Editor-->
                    <!--begin::Description-->
                    <div class="text-muted fs-7">Set the date of the replacement to process.</div>
                    <!--end::Description-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" id="gitBag" name="gift_bag">
                    ...
                    <div class="col">
                        <!--begin::Checkbox-->
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" id="giftWrap" name="gift_wrap">
