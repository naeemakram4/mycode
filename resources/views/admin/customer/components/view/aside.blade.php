        ...
        <div class="card-body pt-15">
            ...
            <div class="d-flex flex-center flex-column mb-5">
                ...
                <div class="symbol symbol-100px symbol-circle mb-7">
                    <img src="{{asset("/settings/top-menu-cooco-logo.png")}}" alt="Profile Image">
                </div>
                <!--end::Avatar-->
                <!--begin::Name-->
                <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">{{ $customer->getFullName() }}</a>
                <!--end::Name-->
                <!--begin::Position-->
                <div class="fs-5 fw-bold text-muted mb-6">{{ $customer->origin->name }}</div>
                <!--end::Position-->
                <!--begin::Info-->
                <div class="d-flex flex-wrap flex-center">
                    ...
                    <div class="border border-gray-300 border-dashed rounded text-center py-3 px-3 mb-3">
                        <div class="fs-4 fw-bolder text-gray-700">
                            <span class="w-75px">{{ $customer->orders->count() }}</span>
                        </div>
                    ...
                    <div class="border border-gray-300 border-dashed rounded text-center py-3 px-3 mx-4 mb-3">
                        <div class="fs-4 fw-bolder text-gray-700">
                            <span class="w-50px">{{ $customer->replacements->count() }}</span>
                        </div>
            ...
            <div class="d-flex flex-stack fs-4 py-3">
                ...
                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title=""
                    ...
                    <a href="{{ route('edit_customer', $customer->id) }}" class="btn btn-sm btn-light-primary">Edit</a>
                </span>
            </div>
            <!--end::Details toggle-->
            ...
            <div id="kt_customer_view_details" class="collapse show">
                <div class="py-5 fs-6">
                    <!--begin::Badge-->
                    <div class="badge badge-light-{{ $customer->status == 1 ? 'success' : 'danger' }} d-inline">
                       {{ $customer->status == 1 ? 'Active' : 'Inactive' }}
                    </div>
                    <!--begin::Badge-->
                    <!--begin::Details item-->
                    <div class="fw-bolder mt-5">Account ID</div>
                    <div class="text-gray-600">CU-{{ $customer->id }}</div>
                    <!--begin::Details item-->
                    <!--begin::Details item-->
                    ...
                    <!--begin::Details item-->
                    <!--begin::Details item-->
                    <div class="fw-bolder mt-5">Platform</div>
                    <div class="text-gray-600">{{ $customer->origin->name }}</div>
                    <!--begin::Details item-->
                    <!--begin::Details item-->
                    <div class="fw-bolder mt-5">Created At</div>
                    <div class="text-gray-600">{{ $customer->created_at->format('m-d-Y') }}</div>
                    <!--begin::Details item-->
                </div>
            </div>
            <!--end::Details content-->
