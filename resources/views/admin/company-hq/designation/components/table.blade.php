<table id="kt_datatable_example_1" class="table table-row-bordered gy-5">
    ...
    @if (count($designations) > 0)
        @foreach($designations as $designation)
            ...
            <td>
                <span class="badge badge-light-dark">{{ $designation->department->name }}</span>
            </td>
            <td>
            ...
            <td>
                <div class="d-flex justify-content-end flex-shrink-0">
                    <a href="javascript:void(0);" id="editDesignation" data-id="{{ $designation->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                    ...
                    <a href="javascript:void(0);"
                       onclick="if(confirm('Are you sure to delete?')){ event.preventDefault(); document.getElementById('delete-designation-{{ $designation->id }}').submit();}"
...
@section('pageInnerModals')
    @include('admin.company-hq.designation.components.add_new_designation_modal')
    @include('admin.company-hq.designation.components.edit-modal')
@endsection
