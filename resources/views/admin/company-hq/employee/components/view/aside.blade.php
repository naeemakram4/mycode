    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-body pt-15">
            ...
            <div class="d-flex flex-center flex-column mb-5">
                ...
                <!--end::Name-->
                <!--begin::Position-->
                <div class="fs-5 fw-bold text-muted mb-6">{{ $employee->designation->name }}</div>
                <!--end::Position-->
                <!--begin::Info-->
                <div class="d-flex flex-wrap flex-center">
                    ...
                    <div class="border border-gray-300 border-dashed rounded text-center py-3 px-3 mb-3">
                        <div class="fs-4 fw-bolder text-gray-700">
                            <span class="w-75px">{{ $employee->orders->count() }}</span>
                        </div>
                    ...
                    <div class="border border-gray-300 border-dashed rounded text-center py-3 px-3 mx-4 mb-3">
                        <div class="fs-4 fw-bolder text-gray-700">
                            <span class="w-50px">{{ $employee->replacements->count() }}</span>
                        </div>
            ...
            <div class="d-flex flex-stack fs-4 py-3">
                ...
                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title=""
                    ...
                    <a href="javascript:void(0);" id="editEmployee" data-id="{{ $employee->id }}" class="btn btn-sm btn-light-primary">Edit</a>
                </span>
            </div>
            <!--end::Details toggle-->
            ...
            <div id="kt_customer_view_details" class="collapse show">
                <div class="py-5 fs-6">
                    ...
                    <div class="text-gray-600">EMP-{{ $employee->id }}</div>
                    <!--begin::Details item-->
                    <!--begin::Details item-->
                    ...
                    <div class="text-gray-600">{{ $employee->department->name }}</div>
                    <!--begin::Details item-->
                    <!--begin::Details item-->
                    <div class="fw-bolder mt-5">Designation</div>
                    <div class="text-gray-600">{{ $employee->designation->name }}</div>
                    <!--begin::Details item-->
                    <!--begin::Details item-->
