            ...
            <div class="form-group">
                <div class="form-group row mb-5">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id='category' class="form-select form-select-sm form-select-solid"
                                data-control="select2" data-hide-search="true">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id='carrier' class="form-select form-select-sm form-select-solid"
                                data-control="select2" data-hide-search="true">
                            <option value="">All Carrier</option>
                            @foreach($carriers as $carrier)
                                <option value="{{ $carrier->CarrierKey }}">{{ $carrier->Name }}</option>
                            @endforeach
                        </select>
                    </div>

                    <div class="col-md-3">
                        <a href="" data-repeater-delete class="btn btn-sm btn-light-primary mt-3 mt-md-9">
