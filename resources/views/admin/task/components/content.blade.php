                ...
                <div class="tab-pane fade active show" id="kt_contact_view_general" role="tabpanel">
                    ...
                    <div class="d-flex flex-column gap-5 mt-7">
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="fw-bolder fs-5">Perkins Orthodontics</div>
                        </div>
                        <!--end::Company name-->
                        <!--begin::City-->
                        <div class="d-flex flex-column gap-1">
                            <div class="fw-bolder text-muted">Service</div>
                            <div class="fw-bolder fs-5">Web Maintenance</div>
                        </div>
                        <!--end::City-->
                        <!--begin::Country-->
                        <div class="d-flex flex-column gap-1">
                            <div class="fw-bolder text-muted">Created By</div>
                            <div class="fw-bolder fs-5">Houmanity</div>
                        </div>

                        <div class="d-flex flex-column gap-1">
                            <div class="fw-bolder text-muted">Date/ Due Date</div>
                            <div class="fw-bolder fs-5">08/08/2023 <br> 17/08/2023</div>
                        </div>
                        <!--end::Country-->
                        <!--begin::Notes-->
                        <div class="d-flex flex-column gap-1">
                            <div class="fw-bolder text-muted">Description</div>
                            <p>Emma Smith joined the team on September 2019 as a junior associate. She soon showcased her expertise and experience in knowledge and skill in the field, which was very valuable to the company. She was promptly promoted to senior associate on July 2020.</p>
                        </div>
                        <!--end::Notes-->
                        <div class="d-flex flex-column gap-1">
