        ...
        <div class="card-body pt-5">
            ...
            <div class="d-flex flex-column gap-5">
                ...
                <div class="d-flex flex-stack">
                    <a href="{{ route('admin.task.index') }}" class="fs-6 fw-bolder text-gray-800 text-hover-primary text-active-primary active">All Group</a>
                    <div class="badge badge-light-primary"></div>
                </div>

                @foreach($groups as $group)
                    <div class="d-flex flex-stack">
                        <a href="{{ route('admin.task.view.group.tasks', $group->id) }}" class="fs-6 fw-bolder text-gray-800 text-hover-primary text-active-primary">
                            {{ $group->name }}
                        </a>
            ...
            <!--begin::Separator-->
            <form action="{{ route('admin.task.add.group') }}" method="POST">
                @csrf
